...
<dftools:workflow xmlns:dftools="http://net.sf.dftools">
    ...
    <dftools:task
        pluginId="org.ietr.preesm.stats.exporter.StatsExporterTask" taskId="Stats Exporter">
    ...
    <dftools:dataTransfer from="scenario" sourceport="scenario"
        targetport="scenario" to="Stats Exporter"/>
    <dftools:dataTransfer from="Scheduling" sourceport="ABC"
        targetport="ABC" to="Stats Exporter"/>
    ...
    <dftools:dataTransfer from="DAG Exporter" sourceport="void"
        targetport="void" to="Code Generation"/>
