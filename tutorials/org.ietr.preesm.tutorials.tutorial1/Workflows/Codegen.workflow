...
<dftools:workflow errorOnWarning="true" verboseLevel="FINEST" xmlns:dftools="http://net.sf.dftools">
    ...
    <dftools:task pluginId="pisdf-mapper.list" taskId="ListScheduling">
        <dftools:data key="variables">
    ...
    <dftools:dataTransfer from="ListScheduling" sourceport="ABC"
        targetport="ABC" to="Display Gantt"/>
    <dftools:dataTransfer from="ListScheduling" sourceport="ABC"
        targetport="ABC" to="Gantt Exporter"/>
    <dftools:dataTransfer from="ListScheduling" sourceport="DAG"
    ...
    <dftools:dataTransfer from="scenario"
        sourceport="architecture" targetport="architecture" to="ListScheduling"/>
    <dftools:dataTransfer from="scenario" sourceport="scenario"
        targetport="scenario" to="ListScheduling"/>
    <dftools:dataTransfer from="PiMM2SrDAG" sourceport="PiMM"
        targetport="PiMM" to="ListScheduling"/>
    <dftools:dataTransfer from="PiMM2SrDAG" sourceport="PiMM"
