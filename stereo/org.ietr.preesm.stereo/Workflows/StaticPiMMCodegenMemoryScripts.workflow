...
<dftools:workflow errorOnWarning="true" verboseLevel="INFO" xmlns:dftools="http://net.sf.dftools">
    ...
    <dftools:task pluginId="pisdf-srdag" taskId="PiSDF to Srdag">
        <dftools:data key="variables">
    ...
    <dftools:dataTransfer from="scenario" sourceport="PiMM"
        targetport="PiMM" to="PiSDF to Srdag"/>
    ...
    <dftools:dataTransfer from="PiSDF to Srdag" sourceport="PiMM"
        targetport="PiMM" to="Scheduling"/>
    <dftools:dataTransfer from="PiSDF to Srdag" sourceport="PiMM"
        targetport="PiMM" to="SDF Exporter"/>
</dftools:workflow>
