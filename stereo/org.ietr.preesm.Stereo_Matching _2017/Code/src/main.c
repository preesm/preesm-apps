...
#define X12_CORES
    ...
    pthread_t threadCore6;
    pthread_t threadCore7;
    pthread_t threadCore8;
    pthread_t threadCore9;
    pthread_t threadCore10;
    pthread_t threadCore11;
#else
#ifdef VERBOSE
...
// Creating a synchronization barrier
...
#else
#ifdef X12_CORES
    pthread_barrier_init(&iter_barrier, NULL, 12);
#endif // 8_CORES
#endif // 8_CORES
#endif // 4_CORES
#endif // 1_CORE
    ...
    pthread_create(&threadCore6, NULL, computationThread_Core6, NULL);
    pthread_create(&threadCore7, NULL, computationThread_Core7, NULL);
    pthread_create(&threadCore8, NULL, computationThread_Core8, NULL);
    pthread_create(&threadCore9, NULL, computationThread_Core9, NULL);
    pthread_create(&threadCore10, NULL, computationThread_Core10, NULL);
    pthread_create(&threadCore11, NULL, computationThread_Core11, NULL);
#endif // 12_CORES
#endif // 8_CORES
#endif // 4_CORES
#endif // 1_CORE
...
// Waiting for thread terminations
    ...
    pthread_join(threadCore6,NULL);
    pthread_join(threadCore7,NULL);
    pthread_join(threadCore8,NULL);
    pthread_join(threadCore9,NULL);
    pthread_join(threadCore10,NULL);
    pthread_join(threadCore11,NULL);
#endif // 12_CORES
#endif // 8_CORES
#endif // 4_CORES
#endif // 1_CORE
