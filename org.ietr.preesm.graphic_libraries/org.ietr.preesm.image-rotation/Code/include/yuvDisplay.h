 ...
 */
void yuvDisplay(int id, IN unsigned char *y, IN unsigned char *u,
		IN unsigned char *v);
 ...
 *        the V component of the frame to display
 */
void yuvDisplayWithNbSlice(int id, int nbSlice, IN unsigned char *y,
		IN unsigned char *u, IN unsigned char *v);
 ...
 */
void yuvDisplayInit(int id, int width, int height, int dis_w, int dis_h);
