...
public class preesm6678
{
    ...
    void Platform$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("preesm6678.Platform$$create", new Proto.Fxn(om.findStrict("preesm6678.Platform.Module", "preesm6678"), om.findStrict("preesm6678.Platform.Instance", "preesm6678"), 2, 1, false));
                fxn.addArg(0, "name", $$T_Str, $$UNDEF);
                fxn.addArg(1, "__params", (Proto)om.findStrict("preesm6678.Platform.Params", "preesm6678"), Global.newObject());
        sb = new StringBuilder();
        sb.append("preesm6678$Platform$$create = function( name, __params ) {\n");
        ...
        fxn = (Proto.Fxn)om.bind("preesm6678.Platform$$construct", new Proto.Fxn(om.findStrict("preesm6678.Platform.Module", "preesm6678"), null, 3, 1, false));
        ...
        sb = new StringBuilder();
        sb.append("preesm6678$Platform$$construct = function( __obj, name, __params ) {\n");
            sb.append("var __mod = xdc.om['preesm6678.Platform'];\n");
