...
/**
 * @brief Initializes the state of the system
 *
...
/**
 * @brief Fires the first system state
 *
 * @param state_space_size Size of the system space
 * @param first_state First state of the system
 */
void stateInit(int state_space_size,
				OUT float *first_state);

/**
 * @brief Absorbs the last system state
 *
 * @param state_space_size Size of the system space
 * @param last_state Last state of the system
 */
