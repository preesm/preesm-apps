...
<dftools:workflow xmlns:dftools="http://net.sf.dftools">
    ...
    <dftools:task
        pluginId="org.ietr.preesm.experiment.memory.MultiMemoryBoundsEstimator" taskId="Memory Bounds Estimator">
        <dftools:data key="variables">
    ...
    <dftools:dataTransfer from="MEG Builder" sourceport="DAGsAndMemExs"
        targetport="DAGsAndMemExs" to="Memory Bounds Estimator"/>
    <dftools:dataTransfer from="MEG Builder" sourceport="DAGsAndMemExs"
