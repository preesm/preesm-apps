...
void computeLayerBackPropError(int layer_size, int next_layer_size,
                               IN float *derivative_values, IN float *next_layer_errors, IN float *next_layer_weights,
                               OUT float *errors) {
...
void computeWeightsGradients(int input_size, int layer_size,
                             IN float *errors, IN float *inputs,
                             OUT float *gradients) {
...
void applyAdamOptimizer(int size,
                        IN float *learning_rate, IN double *betas, IN double *epsilon,
...
void adamUpdateBetas(IN double *betas_in,
